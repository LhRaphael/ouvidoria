...
export function AppProvider({ children }) {
    ...
    const [reloadManifestacoes, setReloadManifestacoes] = useState(false); // gerenciar reload das manifestações
    ...
    return (
        <AppContext.Provider value={{ user, setUser, isModalOpen, manageModal, adminPanelData, setAdminPanelData, reloadManifestacoes, setReloadManifestacoes }}>
            {children}
        </AppContext.Provider>
    );
}
